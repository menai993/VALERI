...
import valeri_api.capabilities.models  # noqa: F401  (registers app.capability_proposal)
...
import valeri_api.llm.models  # noqa: F401  (registers app.llm_pricing, app.llm_budget)
