...
from valeri_api.api.admin_llm import router as admin_llm_router
...
from valeri_api.api.inbox import router as inbox_router
...
def create_app() -> FastAPI:
    ...
    application.include_router(admin_llm_router, prefix="/api")
