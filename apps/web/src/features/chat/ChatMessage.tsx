...
import { CaptureChip, type CaptureContent } from "@/components/widgets/CaptureChip"
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* CI1 transparency: what VALERI captured from this message. */}
        {!isUser && capture && <CaptureChip content={capture} />}
