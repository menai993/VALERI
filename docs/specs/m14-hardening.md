...
**Milestone:** M14 · **Builds on:** M0–M13 (the complete system) · **Status:** implemented (250 backend + 56 web tests green; backups/logging/perf/runbook/acceptance-report delivered, 2026-06-03)
