...
**Milestone:** M8 · **Builds on:** M7 (all dashboard data exists: metrics, signals, tasks, owner report) · **Status:** implemented (backend 132 tests + web 29 tests green, 2026-06-03)
